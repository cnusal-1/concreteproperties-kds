...
def nb_17_deck_design():
    ...
    return write(
        ...
        원리를 그림으로 따라가려면
        [강의 L4 (내측)](../lectures/L4_바닥판설계_내측슬래브.ipynb) 와
        [강의 L5 (외측)](../lectures/L5_바닥판설계_외측슬래브.ipynb) 를, 값을 슬라이더로 바꿔
...
"교량 바닥판 설계 흐름",
[
    ("교량 제원과 재하차로 수", "24 12 21 4.3.1.1"),
    ("두께와 피복", "24 14 21 4.6.5.1, 4.4.4"),
    ("내측부 하중 (식 4.6-1, 표 4.6-2)", "24 10 11 4.6.2.4, 4.6.2.7"),
    ("하중조합 극한Ⅰ·사용Ⅰ", "24 12 11 표 4.1-1"),
    ("내측부 휨 설계", "24 14 21 4.1.1"),
    ("캔틸레버부 (식 4.6-4)", "24 10 11 4.6.2.5"),
    ("배력철근 120/√L ≤ 67 %", "24 14 21 4.6.5.3(2)"),
    ("사용성 — 응력·균열·처짐", "24 14 21 4.2"),
    ("KDS 14 강도설계법과 대조", "14 20 20 4.1"),
],
)
'''),
            code("""
...
def nb_19_girder_shear():
    """예제 19 - PSC I형 거더 전단설계 (KDS 24)."""
    return write(
        "19_girder_shear",
        [
            md(r"""
