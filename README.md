...
| | 균열 제어 철근 간격, 수축·온도철근 | KDS 14 20 30 4.3, 4.4 |
...
| `psc` | 긴장재·콘크리트 허용응력, 균열등급 | KDS 14 20 62 4.2 |
| | 프리스트레스 손실 6종 | KDS 14 20 62 4.3 |
| | 부착·비부착 $f_{ps}$, PSC 강도감소계수 | KDS 14 20 62 4.1 |
...
>
> 특히 확인이 필요한 곳:
> - KDS 14 20 20 표 4.1-1 의 $\eta$, $\beta_1$, $\varepsilon_{cu}$ (fck 50~90)
